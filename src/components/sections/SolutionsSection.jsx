...
function SolutionsSection(){
    ...
    return <section className='solution__section'>
        <div className="solution__bg-image">
            <div className="solution__section_department">
            ...
            <div className="solution__section_description">
                <div className="container">
                    <div className="description__top flex-container">
                        <div className="description__top_left">
                            <h2>Об услуге</h2>
                        ...
                        <div className="description__top_right">
                            <div className="top-block">
                                ...
                                <a href={BK_Pres_2020} target='_blank' rel="noopener noreferrer"
                                   className="text btn btn__white_border">Скачать презентацию</a>
                    ...
                    <div className="description__bottom flex-container">
                        <div className="first-solution">
                            ...
                            <h3>
                                Документы, которые потребуются для получения предварительного классификационного
                                решения:
                            </h3>
                            <ul>
